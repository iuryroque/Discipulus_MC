        ...
        sx={{
            ...
            <CardContent sx={{ flexGrow: 1, p: 3 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
                    ...
                    <Tooltip title="Editar Visitante">
                        <IconButton 
                            size="small" 
                            onClick={(e) => {
                                e.stopPropagation(); // Impede que o clique no botão marque o card
                                onEdit(pessoa.id);
                            }}
                        >
                            <Edit />
                    ...
                    <Checkbox
                        ...
                        onClick={(e) => e.stopPropagation()} // Evita que o clique no checkbox acione o clique no card
                    />
                </Box>
                <Divider sx={{ my: 2 }} />
                <Box sx={{ mb: 2 }}>
